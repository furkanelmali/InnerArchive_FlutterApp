...
#ifndef INNER_ARCHIVE_SWIFT_H
#define INNER_ARCHIVE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="inner_archive",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC13inner_archive11AppDelegate")
...
SWIFT_CLASS("_TtC13inner_archive17MainFlutterWindow")
